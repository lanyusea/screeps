...
{PROMPT_GAMEPLAY_RESPONSE_TEMPLATE}"""
    ...
    def test_rejects_prompt_only_gameplay_response_template_with_required_output_intro(self) -> None:
        artifact = f"""# Cron Job: Screeps Gameplay Evolution Review
...
{PROMPT_GAMEPLAY_RESPONSE_TEMPLATE}"""
        ...
        diagnostic = finalization.diagnose_text(
            artifact,
            path="prompt-only-required-output-template.md",
            mode="gameplay-review",
            route_issue="#1860",
            expected_job_id="c7b3dda8f1ac",
        )
...
{VALID_GAMEPLAY_RESPONSE}"""
    ...
    def test_accepts_real_response_after_required_output_prompt_gameplay_response_template(self) -> None:
        artifact = f"""# Cron Job: Screeps Gameplay Evolution Review
...
{VALID_GAMEPLAY_RESPONSE}"""
        ...
        diagnostic = finalization.diagnose_text(
            artifact,
            path="final-response-after-required-output-template.md",
            mode="gameplay-review",
            route_issue="#1860",
            expected_job_id="c7b3dda8f1ac",
        )
