...
<section class="section"><div class="section-title"><h2>04 Delivery Metrics</h2></div><div class="metrics">${report.processCards.map(metric).join('')}</div></section>
