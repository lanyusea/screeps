...
class ScreepsRlControlLoopLedgersTest(unittest.TestCase):
    ...
    def test_training_ledger_preserves_prior_run_and_reports_newer_pending_card_supply(self) -> None:
        ...
        self.assertEqual(payload["cardSupply"]["status"], "PRIMARY_SATISFIED")
        self.assertNotEqual(payload["cardSupply"]["status"], "DEGRADED")
        self.assertEqual(payload["cardSupply"]["source"], "standalone_experiment_card")
        self.assertEqual(payload["cardSupply"]["cardId"], fresh_card["card_id"])
        self.assertEqual(payload["cardSupply"]["cardSupply"]["state"], "available")
        self.assertTrue(payload["cardSupply"]["cardSupply"]["available_for_training"])
        self.assertEqual(pending["cardId"], fresh_card["card_id"])
