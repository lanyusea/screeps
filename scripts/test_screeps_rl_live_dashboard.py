...
class ScreepsRlLiveDashboardTest(unittest.TestCase):
    ...
    def test_refresh_is_repeatable_and_summary_covers_live_observability(self) -> None:
        ...
        project_gate_issues = {row["issue"] for row in summary["projectGates"]}
        self.assertIn("#1576", project_gate_issues)
        self.assertNotIn("#879", project_gate_issues)
        self.assertNotIn("#879", json.dumps(summary, sort_keys=True))
        ...
        self.assertIn("RL Flywheel Stage Proof", html)
        self.assertNotIn("#879 Flywheel Stage Proof", html)
        self.assertNotIn("#879", html)
