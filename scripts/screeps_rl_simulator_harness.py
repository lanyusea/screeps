...
def apply_runtime_parameter_injection_to_code(code_text: str, injection: JsonObject) -> str:
    ...
    epilogue = (
        ...
        "    if (!container || typeof container.loop !== 'function' || container.__screepsRlRuntimePolicyConsumptionWrapped) return;\n"
        "    var originalLoop = container.loop;\n"
        ...
        "    };\n"
        "    try {\n"
        "      Object.defineProperty(container, '__screepsRlRuntimePolicyConsumptionWrapped', {\n"
        "        value: true,\n"
        "        configurable: true\n"
        "      });\n"
        "    } catch (err) { container.__screepsRlRuntimePolicyConsumptionWrapped = true; }\n"
        "  }\n"
        "  try {\n"
        "    if (typeof module !== 'undefined' && module && module.exports) {\n"
        "      wrapLoop(module.exports);\n"
        "      if (module.exports.default && typeof module.exports.default === 'object') wrapLoop(module.exports.default);\n"
        "    }\n"
        "  } catch (err) {}\n"
        "})();\n"
    )
