...
class RuntimeKpiReducerTest(unittest.TestCase):
    def test_aggregates_runtime_summary_kpis_and_ignores_bad_lines(self) -> None:
            ...
            "rooms": [
                {
                    ...
                    "constructionDeadlockTicks": 100,
                    "extensionCount": 1,
                    "extensionCapacityContribution": 50,
                    "behavior": {"totals": {"pathFindingFailures": 2, "destinationBlocked": 1}},
                    "workerLoadEfficiency": {"tripEnergyMean": 8, "tripEnergyMin": 5},
                    "cpuUsed": 5.0,
                    "cpuBucket": 9000,
                    "rclLevel": 2,
                    "storedEnergy": 175,
            ...
            "rooms": [
                {
                    ...
                    "constructionSiteCount": 2,
                    "constructionDeadlockTicks": 120,
                    "extensionCount": 2,
                    "extensionCapacityContribution": 100,
                    "behavior": {"totals": {"pathFindingFailures": 0, "destinationBlocked": 0}},
                    "workerLoadEfficiency": {"tripEnergyMean": 12, "tripEnergyMin": 10},
                    "cpuUsed": 6.0,
                    "cpuBucket": 8990,
                    "rclLevel": 2,
                    "storedEnergy": 210,
        ...
        self.assertEqual(report["constructionActivity"]["status"], "observed")
        self.assertEqual(report["constructionActivity"]["acceptedRoomCount"], 1)
        self.assertEqual(report["constructionActivity"]["stateCounts"], {"active": 1})
        self.assertEqual(report["constructionActivity"]["rooms"]["W1N1"]["latest"]["state"], "active")
        self.assertEqual(
            report["constructionActivity"]["rooms"]["W1N1"]["latest"]["reason"],
            "build_energy_carried",
        )

    def test_reports_explicit_construction_activity_states(self) -> None:
        report = reducer.reduce_runtime_kpis(
            [
                runtime_line(
                    {
        ...
        self.assertEqual(construction_activity["observedRoomCount"], 3)
        self.assertEqual(construction_activity["acceptedRoomCount"], 2)
        self.assertEqual(
            construction_activity["stateCounts"],
            {"active": 1, "candidate_suppressed": 1, "no_viable_candidate": 1},
        )
        self.assertEqual(
