...
| --- | ---: | --- |
| Active dev/Codex agents | 8 | 2.0x scaled capacity from the prior 4-lane cap (2026-05-05: 1.2x expansion from 6-lane). May include code and docs workers. Do not exceed if PR review backlog is unhealthy. |
