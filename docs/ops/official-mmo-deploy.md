...
- Code branch: `main`
- World shard/room: `shardX/E48S29`
...
python3 scripts/screeps_official_deploy.py \
  --deploy \
  --activate-world \
  --confirm "deploy main to shardX/E48S29" \
...
- `confirmation`: required for deploy mode, exactly `deploy main to shardX/E48S29`.
...
After a successful live deploy, capture runtime evidence for `shardX/E48S29`:
