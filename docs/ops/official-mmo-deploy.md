...
- Code branch: `main`
- World shard/room: `shardX/E46S43`
...
- `confirmation`: required for deploy mode, exactly `deploy main to shardX/E46S43`.
...
After a successful live deploy, capture runtime evidence for `shardX/E46S43`:
