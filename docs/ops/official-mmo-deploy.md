...
- Code branch: `main`
- World shard/room: `shardX/E24S49`
...
- `confirmation`: required for deploy mode, exactly `deploy main to shardX/E24S49`.
...
After a successful live deploy, capture runtime evidence for `shardX/E24S49`:
